...
export declare class AddToCartComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<AddToCartComponent, "add-to-cart", never, {
    "custom": "custom";
